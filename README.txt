...
Projeto final integrado para o programa de bolsas da Compasso Uol. Este Repositorio funciona em conjunto com o repositorio [coral](https://github.com/caiocesar333/coral) 
...
**Importante: O .env do repositorio tem as seguintes chaves:
MONGO_URL = mongodb+srv://caiocesar333:mega12345678@cluster0.jut0lkc.mongodb.net/?retryWrites=true&w=majority
PASS_SEC = LAMA
JWT_SEC = LAMA
**
```
...
```
O projeto pode ser visto em deploy no [vercel](https://vercel.com/caiocesar333/coralApi)
```
